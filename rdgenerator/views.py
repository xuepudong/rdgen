...
def generator_view(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            supercm = form.cleaned_data['supercm']
            ...
            extras['addcopy'] = 'true' if addcopy else 'false'
            extras['applyprivacy'] = 'true' if applyprivacy else 'false'
            extras['hide_chat_voice'] = 'true' if hide_chat_voice else 'false'
            extras['supercm'] = 'true' if supercm else 'false'
            extras['passpolicy'] = 'true' if passpolicy else 'false'
            extras['no_uninstall'] = 'true' if no_uninstall else 'false'
            extras['disable_install'] = 'true' if disable_install else 'false'
            extras['hideSecuritySettings'] = 'true' if hideSecuritySettings else 'false'
            extras['hideNetworkSettings'] = 'true' if hideNetworkSettings else 'false'
            extras['hideServerSettings'] = 'true' if hideServerSettings else 'false'
            extras['hideRemotePrinterSettings'] = 'true' if hideRemotePrinterSettings else 'false'
            extras['hideTray'] = 'true' if hideTray else 'false'
            extras['allowD3dRender'] = 'true' if allowD3dRender else 'false'
            extras['allowHostnameAsId'] = 'true' if allowHostnameAsId else 'false'
            extras['allowNumericOneTimePassword'] = 'true' if allowNumericOneTimePassword else 'false'
            extras['enableAbr'] = 'true' if enableAbr else 'false'
            extras['viewOnly'] = 'true' if viewOnly else 'false'
            ...
            if platform == 'windows-x86':
                ...
                url = 'https://api.github.com/repos/'+_settings.GHUSER+'/'+_settings.REPONAME+'/actions/workflows/generator-macos-aarch64.yml/dispatches'
            else:
                url = 'https://api.github.com/repos/'+_settings.GHUSER+'/'+_settings.REPONAME+'/actions/workflows/generator-windows.yml/dispatches'
